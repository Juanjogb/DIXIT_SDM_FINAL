...
import dixit.sdm.trabajo.dixit.activities.PlayActivity;

public class SearchGameTask extends AsyncTask<String[], Void, String> {

    private WeakReference<PlayActivity> activity;

    public SearchGameTask(PlayActivity activity) {
